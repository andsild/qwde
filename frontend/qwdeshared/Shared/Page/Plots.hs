...
bollingerPage m@Model{..} = template header [drawPlot bollingerPlot tickers "bollingerPlot" GetBollinger] m

smaPage :: Model -> View Action
smaPage m@Model{..} = template header [drawPlot smaPlot tickers "smaplot"  GetSma] m
